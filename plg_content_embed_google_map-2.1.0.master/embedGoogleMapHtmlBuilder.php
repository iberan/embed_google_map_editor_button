...
// by BI - popup (new variable $pass instead of the simple return)
      if($params->getPopup() == 0) {
	  $width="data-mediabox-width='".$params->getWidth()."'";
      $height="data-mediabox-height='".$params->getHeight()."'";
	  $class="class='jcepopup noicon'";
	  $target="target='_blank'";
	  $pass = "\n<a $width $height $class $target ";
	  } else {
